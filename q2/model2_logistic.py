...
def sigmoid(x): 
    # activation function; calculates sigmoid function
    return 1/(1 + np.exp(-x))
...
def prop(weights, bias, x, y): 
    ...
    # calculates activation and negative log-likelihood cost
...
weights,bias=train(weights,bias,train_x,train_y,200)
